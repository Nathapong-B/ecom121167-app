        ...
        <div className="relative h-max w-full">
            <div className="relative -top-10 bg-gray-900 h-screen w-full">
                <div className="relative max-w-6xl h-full flex justify-start items-center mx-auto">
                    ...
                    <div className="absolute bg-gradient-to-r from-gray-100 to-gray-100/0 md:from-gray-100/0 md:statice w-1/2 text-4xl font-black text-center text-gray-200 flex justify-center">
